...
function AppleMark({ className = '' }) {
  return <svg className={`brand-apple-mark ${className}`} viewBox="0 0 34 34" aria-hidden="true">
    <path fill="currentColor" d="M23.5 10.3c-1.6-.1-2.9 1.1-4.2 1.1-1.4 0-2.8-1.2-4.6-1-3.4.3-6.2 3.2-6.1 7.9.1 2.8 1.1 5.9 2.6 8.2 1.2 1.9 2.7 3.8 4.6 3.7 1.7-.1 2.3-1.1 4.2-1.1 1.8 0 2.4 1.1 4.1 1 2-.1 3.2-1.8 4.4-3.8 1.1-1.8 1.5-3.7 1.6-3.8-.1 0-3.3-1.4-3.3-5.1 0-3.2 2.5-4.8 2.7-4.9-1.4-2.1-3.7-2.2-4.4-2.2-.6 0-1.1 0-1.6 0Zm-.5-2.1c.7-.9 1.1-2.1.9-3.4-1.2 0-2.5.7-3.2 1.5-.7.8-1.2 2.1-1 3.3 1.2.1 2.5-.5 3.3-1.4Z"/>
  </svg>
}
