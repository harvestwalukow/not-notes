...
- Rich-text notes with headings, hyphen lists (including nested lists created with `-` + Space and Tab), checklists, quotes, links, and formatting; pressing Enter on an empty hyphen item removes the bullet
